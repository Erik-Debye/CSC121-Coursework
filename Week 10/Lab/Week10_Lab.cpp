...
//Title
void header(void) {
	cout << "\n\n\tErik Debye \\ 03.04.2022 \\ Lab 10\n";
	cout << "\tTicTacToe - Write to DataFile\n";
	cout << "\tNew Commands: fstream, ios::modes, .empty()\n\n";
}
...
bool winCheck(vector<string> square, string letter);                                 //Flag that checks for Wins
...
int main() {
	...
	do {
		...
		for (int i = 0; i < turns; i++) {
			...
			playerWin = winCheck(square, "X");
			compWin = winCheck(square, "O");
		...
		cout << "\n\n\tPress any key to play again or CRTL + Z to quit: ";
	} while (cin >> anyKey);
...
bool winCheck(vector<string> square, string letter) {
	//HORIZONTAL WINS
	if (square[0] == letter && square[1] == letter && square[2] == letter) {
		//Output board
		outputBoard(square);
		if (letter == "X") {
			cout << "\n\tPlayer won on the top row of squares!\n";
			writeOutComesToFile("\n\tPlayer won on the top row of squares!\n");
		}
		else {
			cout << "\n\tComputer won on the top row of squares!\n";
			writeOutComesToFile("\n\tComputer won on the top row of squares!\n");
		}
		return true;
	}
		...
		outputBoard(square);
		if (letter == "X") {
			cout << "\n\tPlayer won on the middle row of squares!\n";
			writeOutComesToFile("\n\tPlayer won on the middle row of squares!\n");
		}
		else {
			cout << "\n\tComputer won on the middle row of squares!\n";
			writeOutComesToFile("\n\tComputer won on the middle row of squares!\n");
		}
		return true;
	}
		...
		outputBoard(square);
		if (letter == "X") {
			cout << "\n\tPlayer won on the last row of squares!\n";
			writeOutComesToFile("\n\tPlayer won on the last row of squares!\n");
		}
		else {
			cout << "\n\tComputer won on the last row of squares!\n";
			writeOutComesToFile("\n\tComputer won on the last row of squares!\n");
		}
		return true;
	}
	//VERTICAL WINS
		...
		outputBoard(square);
		if (letter == "X") {
			cout << "\n\tPlayer won on the first column of squares!\n";
			writeOutComesToFile("\n\tPlayer won on the first column of squares!\n");
		}
		else {
			cout << "\n\tComputer won on the first column of squares!\n";
			writeOutComesToFile("\n\tComputer won on the first column of squares!\n");
		}
		return true;
	}
		...
		outputBoard(square);
		if (letter == "X") {
			cout << "\n\tPlayer won on the second column of squares!\n";
			writeOutComesToFile("\n\tPlayer won on the second column of squares!\n");
		}
		else {
			cout << "\n\tComputer won on the second column of squares!\n";
			writeOutComesToFile("\n\tComputer won on the second column of squares!\n");
		}
		return true;
	} 
		...
		outputBoard(square);
		if (letter == "X") {
			cout << "\n\tPlayer won on the third column of squares!\n";
			writeOutComesToFile("\n\tPlayer won on the third column of squares!\n");
		}
		else {
			cout << "\n\tComputer won on the third column of squares!\n";
			writeOutComesToFile("\n\tComputer won on the third column of squares!\n");
		}
		return true;
	}
	//DIAGONAL WINS 
		...
		outputBoard(square);
		if (letter == "X") {
			cout << "\n\tPlayer won on the decreasing diagonal!\n";
			writeOutComesToFile("\n\tPlayer won on the decreasing diagonal!\n");
		}
		else {
			cout << "\n\tComputer won on the decreasing diagonal!\n";
			writeOutComesToFile("\n\tComputer won on the decreasing diagonal!\n");
		}
		return true;
	}
		...
		outputBoard(square);
		if (letter == "X") {
			cout << "\n\tPlayer won on the increasing diagonal!\n";
			writeOutComesToFile("\n\tPlayer won on the increasing diagonal!\n");
		}
		else {
			cout << "\n\tComputer won on the increasing diagonal!\n";
			writeOutComesToFile("\n\tComputer won on the increasing diagonal!\n");
		}
		return true;
	}
